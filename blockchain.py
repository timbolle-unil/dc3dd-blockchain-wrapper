...
class BlockChainWriter():
    ...
    def Write_to_blockChain(self, file_name):
        ...
        print("Sending hash values of %s to the blockchain..." % (self.config["file_name"]))
        ...
        print("Hash added to the blockchain!")
        print("The PDF receipt %s was created!" % (self.c["name"]))
        print("The URL to verify the integrity of the block is:\n\t%s" % (self.c["qr_data"]))
